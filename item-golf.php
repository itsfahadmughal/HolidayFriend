...
if(isset($_POST['submit'])){
    ...
    $time=date("H:i", strtotime($_POST['input_time']));
    $placetype=$_POST['input_place_type'];
    ...
    $sql="INSERT INTO `tbl_custom_entity_golf`(`custe_id`, `first_name`, `last_name`, `room_number`, `people`, `date`, `wished_time`, `place_type`, `note`, `entrytime`, `entrybyip`, `lastedittime`, `lasteditbyip`, `status_id`) VALUES ($item_id,'$firstname','$lastname','$roomnumber', '$people', '$date', '$time', '$placetype', '$note','$entry_time','$entryby_ip','$last_edit_time','$last_editby_ip',1)";
    ...
    if(!$stmt){
        ...
        echo '<script>alert("Reserved Successfully..."); window.location.href = "item";</script>';    
    }
                    ...
                    <div class ="col-xl-12 col-md-12 col-sm-12 mt-2 pr-3 pl-3 pb-3 mobile_padding_none bgfull-affect-div">
                        ...
                        <div class="row m-0 bg-white-opacity pt-3 pr-3 pl-3 pb-3 div-shadow-mobile">
                            <div class="col-xl-12 col-md-12 col-sm-12" style="text-align:right;">
                                <a href="javascript:void(0)" onclick="order_expand()" class="btn  text-white button-background-color btn-primary">Reserve <i class="fa fa-envelope text-white"></i></a>
                        ...
                        <form method="post">
                            <div class="row m-0 bg-white-opacity pt-3 pr-3 pl-3 pb-3 div-shadow-mobile" id="order_div" style="display:none;">
                                ...
                                <div class="col-xl-6 col-md-6 col-sm-6">
                                    <div class="form-group p-2">
                                        <label class="form-control-label" for="input_people">People</label>
                                        <select class="form-control" name="input_people" id="input_people">
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-4">
                                    <div class="form-group p-2">
                                        <label class="form-control-label" for="input_time">Wished Time (can variate minimally):</label>
                                        <input type="time" id="input_time" name="input_time" class="form-control" required>
                                    </div>
                                </div>

                                <div class="col-xl-4 col-md-4 col-sm-4">
                                    <div class="form-group p-2">
                                        <label class="form-control-label" for="input_place_type">Place Type</label>
                                        <select class="form-control" name="input_place_type" id="input_place_type">
                                ...
                                <div class="col-xl-12 col-md-12 col-sm-12 p-2">
                                    <input type="submit" name="submit" value="Reserve" class="btn  text-white button-background-color btn-primary" />
                                </div>
                            </div>
                        </form>
