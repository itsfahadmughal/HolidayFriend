...
$cat_unique_id = array();
$sql="SELECT a.*,b.wine_category FROM tbl_wine_list as a INNER JOIN tbl_wine_category as b ON a.winc_id=b.winc_id WHERE `hotel_id` =  $hotel_id and isactive= 1 ORDER BY a.winc_id";
$result1 = $conn->query($sql);
while($row = mysqli_fetch_array($result1)) {
    array_push($cat_unique_id,$row['winc_id']);
}
...
if(isset($_GET['t_cat_id'])){
    ...
    $sql="SELECT * FROM tbl_wine_category WHERE winc_id=$t_cat_id";
    $result = $conn->query($sql);
    if ($result && $result->num_rows > 0) {
        while($row = mysqli_fetch_array($result)) {
            $category_name=$row[1];
            ...
            function check1() {
                ...
                if (id != "") {
                    if(id == 0){
                        ...
                        window.location.href = "wine?t_cat_id=" + id;
                    }
                } else{
                    alert('Oops.!!');
                }
        ...
        <div class="main-content" id="panel" >
            ...
            <div class="mt-3">
                ...
                <div class="row pt-3">
                    ...
                    <?php 
    $moduleName = "";
        $sql="SELECT * FROM `tbl_user_module_map` WHERE `user_id` = $user_id and `umod_id` = 17";
        $result = $conn->query($sql);
        if ($result && $result->num_rows > 0) {
            while($row = mysqli_fetch_array($result)) {
        ...
        if ($moduleName==""){
            $sql="SELECT * FROM `tbl_util_modules` WHERE `umod_id` = 17";
            $result = $conn->query($sql);
            if ($result && $result->num_rows > 0) {
                while($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-6">
                        <span class="category-select">
                            ...
                            <select name="catagory_id" id="cat_value"  onchange="check1()">
                                ...
                                <?php 
                                $sql="SELECT * FROM tbl_wine_category";
                                $result = $conn->query($sql);
                                if ($result && $result->num_rows > 0) {
                                    while($row = mysqli_fetch_array($result)) {
                                        if($row[0]==$t_cat_id){
                ...
                <?php
                if ($t_cat_id==0){   
                    $sql="SELECT a.*,b.wine_category,c.symbol FROM tbl_wine_list as a INNER JOIN tbl_wine_category as b ON a.winc_id=b.winc_id INNER JOIN tbl_hotel as d ON a.hotel_id=d.hotel_id INNER JOIN tbl_currency as c ON d.curr_id=c.curr_id WHERE a.`hotel_id` = $hotel_id and a.isactive= 1 ORDER BY a.winc_id";
                    ...
                    if ($result2 && $result2->num_rows > 0) {
                        while($row = mysqli_fetch_array($result2)) {
                            ...
                            $Title             =$row["wine_title"];
                            $Description       =$row["description"];
                            $Region            =$row["wine_region"];
                            $Style             =$row["wine_style"];
                            $Recommendation    =$row["recommended_for"];
                            $GlassPrice        =$row["unit_price"];
                            $BottlePrice       =$row["bottle_price"];
                            $Currency          =$row["symbol"];
                            $ImageLink         =$row["img_url"];
                            $CategoryName      =$row["wine_category"];
                            $WineCatId         =$row["winc_id"];

                            if($cat_unique_id[$i] == $row['winc_id']){
                                if($j == 0){
                ?>
                <div class="row pt-3">
                    <div class="col-xl-4 col-md-4 col-sm-4">
                        <h2 class="textstyle ml-3"><?php echo $row['wine_category'] ?></h2>
                    </div>
                </div> 
                <?php
                    $j=1; 
                ...
                <div class="col-xl-6 col-md-6 col-sm-6 mt-3  ">
                    <div class=" mr-3 ml-3 hover-affect-div bg-white bgfull-affect-div">
                ...
                <div class="row pt-3">
                    <div class="col-xl-4 col-md-4 col-sm-4">
                        <h2 class="textstyle mt-3 ml-3"><?php echo $row['wine_category'] ?></h2>
                    </div>
                </div>                        
                <?php
                    $j=1;  
                ...
                <div class='row'>
                    ...
                    <div class="row" class="bg-white" >
                        <div class="col-xl-6 col-md-6 col-sm-6 mt-3  ">
                            <?php
                    $sql="SELECT a.*,b.wine_category,c.symbol FROM tbl_wine_list as a INNER JOIN tbl_wine_category as b ON a.winc_id=b.winc_id INNER JOIN tbl_hotel as d ON a.hotel_id=d.hotel_id INNER JOIN tbl_currency as c ON d.curr_id=c.curr_id WHERE 
                    a.`hotel_id` = $hotel_id and a.isactive= 1 AND a.winc_id = $t_cat_id ORDER BY a.winc_id";
                    //                    WHERE `hotel_id` =  $hotel_id and isactive= 1 ORDER BY a.winc_id";
                    ...
                    if ($result && $result->num_rows > 0) {
                        ...
                        <div class=" mr-3 ml-3 mt-3 hover-affect-div bg-white bgfull-affect-div">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-6 mt-3 ">
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-6 mt-3  ">
                            <div class=" mr-3 ml-3 mt-3 hover-affect-div bg-white bgfull-affect-div bgfull-affect-div">
