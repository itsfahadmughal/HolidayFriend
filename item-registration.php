...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO `tbl_custom_entity_register`(`custe_id`, `first_name`, `last_name`, `room_number`, `email`, `phone`, `adults`, `kids`, `date`, `note`, `entrytime`, `entrybyip`, `lastedittime`, `lasteditbyip`, `status_id`) VALUES ($item_id,'$firstname','$lastname','$roomnumber', '$email', '$phone', $adults, $kids, '$date', '$note','$entry_time','$entryby_ip','$last_edit_time','$last_editby_ip',1)";
    ...
    if(!$stmt){
        ...
        echo '<script>alert("Registered Successfully..."); window.location.href = "item";</script>';    
    }
                    ...
                    <div class ="col-xl-7 col-md-7 col-sm-7  pr-3 pl-3 pb-3 mobile_padding_none bgfull-affect-div">
                        ...
                        <div class="row m-0 bg-white-opacity pt-3 pr-3 pl-3 pb-3 div-shadow-mobile">
                            <div class="col-xl-12 col-md-12 col-sm-12" style="text-align:right;">
                                <a href="javascript:void(0)" onclick="order_expand()" class="btn  text-white button-background-color btn-primary">Register <i class="fa fa-envelope text-white"></i></a>
                            ...
                            <div class="row m-0 bg-white-opacity pt-3 pr-3 pl-3 pb-3 div-shadow-mobile" id="order_div" style="display:none;">
                                ...
                                <div class="col-xl-6 col-md-6 col-sm-6">
                                    <div class="form-group p-2">
                                        ...
                                        <input type="text" id="input_phone" name="input_phone" class="form-control"  required>
                                    </div>
                                </div>
